...
class MakeLinkBtn(nextcord.ui.View):
    def __init__(self, link: str, text: str):
        super().__init__()
        self.add_item(nextcord.ui.Button(label=text, url=link))
...
class Rtfm(commands.Cog):
    ...
    async def do_rtfm(self, ctx, key, obj):
        page_types = {
            ...
            "nextcord": "https://discordpy.readthedocs.io/en/stable/",
        ...
        await ctx.send(embed=e, reference=refer, view=linkView)
    ...
    @rtfm_group.command(name="nextcord", aliases=["dpy"])
    ...
    async def rtfmcache(self, ctx: commands.Context):
        ...
        embed = nextcord.Embed(title="Purged rtfm cache.")
